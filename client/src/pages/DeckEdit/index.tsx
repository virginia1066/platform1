        ...
        <PageWrap headerTitle={t('header')}>
            <Flex h={'full'}>
                <Block h={'max-content'}>
                    ...
                    <FormElement placeholder={t('placeholder.title')} default_value={''} onChange={handleInputChange} validate={validation}/>
                            ...
                            <Block bgColor={get_triteary_bg_color(colorScheme)} flexDir={'column'}>
                                <Flex gap={4} alignItems={'center'}>
                                    <Flex direction={'column'} gap={3}>
                                        <FormElement placeholder={t('placeholder.lang1')} default_value={''} onChange={handleInputChange} validate={validation}/>
                                        <FormElement placeholder={t('placeholder.lang2')} default_value={''} onChange={handleInputChange} validate={validation}/>
                                    </Flex>
                                    <IconButton size={'xs'} variant={'delete'} aria-label='Delete' icon={<CloseIcon w={'10px'} h={'10px'} />} />
                                </Flex>                            
                            </Block>
                            <IconButton bgColor={themeParams.button_text_color} color={themeParams.button_color} borderWidth={'2px'} alignSelf={'center'} variant={'main'} size={'lg'} aria-label='Add' icon={<AddIcon />} />                            
                        </VStack>
                    </VStack>
                </Block>
            </Flex>
